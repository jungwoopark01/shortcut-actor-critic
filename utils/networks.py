...
class ActorVectorFieldShortcut(nn.Module):
    """Actor vector field network for shortcut.
    ...
    @nn.compact
    def __call__(self, observations, actions, times, step_sizes, is_encoded=False):
        """Return the vectors at the given states, actions, times, and step sizes.
